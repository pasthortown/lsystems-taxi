...
class Controlador_motivocalificacionunidad extends Controlador_Base
{
   ...
   function leer($args)
   {
      $id = $args["id"];
      if ($id==""){
         $sql = "SELECT * FROM MotivoCalificacionUnidad;";
      }else{
      $parametros = array($id);
         $sql = "SELECT * FROM MotivoCalificacionUnidad WHERE id = ?;";
      }
      $respuesta = $this->conexion->ejecutarConsulta($sql,$parametros);
      return $respuesta;
   }
   ...
   function leer_paginado($args)
   {
      ...
      $sql ="SELECT * FROM MotivoCalificacionUnidad LIMIT $desde,$registrosPorPagina;";
      $respuesta = $this->conexion->ejecutarConsulta($sql,$parametros);
      return $respuesta;
   }
   ...
   function leer_filtrado($args)
   {
      ...
      switch ($tipoFiltro){
         case "coincide":
            ...
            $sql = "SELECT * FROM MotivoCalificacionUnidad WHERE $nombreColumna = ?;";
            break;
         case "inicia":
            $sql = "SELECT * FROM MotivoCalificacionUnidad WHERE $nombreColumna LIKE '$filtro%';";
            break;
         case "termina":
            $sql = "SELECT * FROM MotivoCalificacionUnidad WHERE $nombreColumna LIKE '%$filtro';";
            break;
