...
@Component({
   selector: 'app-motivocalificacionunidad',
   templateUrl: './motivocalificacionunidad.component.html',
   styleUrls: ['./motivocalificacionunidad.component.scss']
})

export class MotivoCalificacionUnidadComponent implements OnInit {

   busy: Promise<any>;
   entidades: MotivoCalificacionUnidad[];
   entidadSeleccionada: MotivoCalificacionUnidad;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: MotivoCalificacionUnidadService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: MotivoCalificacionUnidad): boolean {
      return true;
   }
   ...
   crearEntidad(): MotivoCalificacionUnidad {
      const nuevoMotivoCalificacionUnidad = new MotivoCalificacionUnidad();
      nuevoMotivoCalificacionUnidad.id = 0;
      return nuevoMotivoCalificacionUnidad;
   }

   add(entidadNueva: MotivoCalificacionUnidad): void {
   ...
   update(entidadParaActualizar: MotivoCalificacionUnidad): void {
   ...
   delete(entidadParaBorrar: MotivoCalificacionUnidad): void {
   ...
   refresh(): void {
      ...
      this.entidades = MotivoCalificacionUnidad[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: MotivoCalificacionUnidad): void {
