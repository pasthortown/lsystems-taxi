...
@Component({
   selector: 'app-fotografiaunidad',
   templateUrl: './fotografiaunidad.component.html',
   styleUrls: ['./fotografiaunidad.component.scss']
})

export class FotografiaUnidadComponent implements OnInit {

   busy: Promise<any>;
   entidades: FotografiaUnidad[];
   entidadSeleccionada: FotografiaUnidad;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: FotografiaUnidadService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: FotografiaUnidad): boolean {
      return true;
   }
   ...
   crearEntidad(): FotografiaUnidad {
      const nuevoFotografiaUnidad = new FotografiaUnidad();
      nuevoFotografiaUnidad.id = 0;
      return nuevoFotografiaUnidad;
   }

   add(entidadNueva: FotografiaUnidad): void {
   ...
   update(entidadParaActualizar: FotografiaUnidad): void {
   ...
   delete(entidadParaBorrar: FotografiaUnidad): void {
   ...
   refresh(): void {
      ...
      this.entidades = FotografiaUnidad[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: FotografiaUnidad): void {
