...
export class EstadoCuentaComponent implements OnInit {
   ...
   busy: Promise<any>;
   entidades: EstadoCuenta[];
   entidadSeleccionada: EstadoCuenta;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: EstadoCuentaService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: EstadoCuenta): boolean {
      return true;
   }
   ...
   crearEntidad(): EstadoCuenta {
      const nuevoEstadoCuenta = new EstadoCuenta();
      nuevoEstadoCuenta.id = 0;
      return nuevoEstadoCuenta;
   }

   add(entidadNueva: EstadoCuenta): void {
   ...
   update(entidadParaActualizar: EstadoCuenta): void {
   ...
   delete(entidadParaBorrar: EstadoCuenta): void {
   ...
   onSelect(entidadActual: EstadoCuenta): void {
