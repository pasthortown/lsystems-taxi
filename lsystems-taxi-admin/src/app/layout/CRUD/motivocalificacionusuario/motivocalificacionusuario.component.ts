...
@Component({
   selector: 'app-motivocalificacionusuario',
   templateUrl: './motivocalificacionusuario.component.html',
   styleUrls: ['./motivocalificacionusuario.component.scss']
})

export class MotivoCalificacionUsuarioComponent implements OnInit {

   busy: Promise<any>;
   entidades: MotivoCalificacionUsuario[];
   entidadSeleccionada: MotivoCalificacionUsuario;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: MotivoCalificacionUsuarioService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: MotivoCalificacionUsuario): boolean {
      return true;
   }
   ...
   crearEntidad(): MotivoCalificacionUsuario {
      const nuevoMotivoCalificacionUsuario = new MotivoCalificacionUsuario();
      nuevoMotivoCalificacionUsuario.id = 0;
      return nuevoMotivoCalificacionUsuario;
   }

   add(entidadNueva: MotivoCalificacionUsuario): void {
   ...
   update(entidadParaActualizar: MotivoCalificacionUsuario): void {
   ...
   delete(entidadParaBorrar: MotivoCalificacionUsuario): void {
   ...
   refresh(): void {
      ...
      this.entidades = MotivoCalificacionUsuario[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: MotivoCalificacionUsuario): void {
