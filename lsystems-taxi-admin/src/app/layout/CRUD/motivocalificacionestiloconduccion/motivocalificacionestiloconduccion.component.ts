...
@Component({
   selector: 'app-motivocalificacionestiloconduccion',
   templateUrl: './motivocalificacionestiloconduccion.component.html',
   styleUrls: ['./motivocalificacionestiloconduccion.component.scss']
})

export class MotivoCalificacionEstiloConduccionComponent implements OnInit {

   busy: Promise<any>;
   entidades: MotivoCalificacionEstiloConduccion[];
   entidadSeleccionada: MotivoCalificacionEstiloConduccion;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: MotivoCalificacionEstiloConduccionService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: MotivoCalificacionEstiloConduccion): boolean {
      return true;
   }
   ...
   crearEntidad(): MotivoCalificacionEstiloConduccion {
      const nuevoMotivoCalificacionEstiloConduccion = new MotivoCalificacionEstiloConduccion();
      nuevoMotivoCalificacionEstiloConduccion.id = 0;
      return nuevoMotivoCalificacionEstiloConduccion;
   }

   add(entidadNueva: MotivoCalificacionEstiloConduccion): void {
   ...
   update(entidadParaActualizar: MotivoCalificacionEstiloConduccion): void {
   ...
   delete(entidadParaBorrar: MotivoCalificacionEstiloConduccion): void {
   ...
   refresh(): void {
      ...
      this.entidades = MotivoCalificacionEstiloConduccion[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: MotivoCalificacionEstiloConduccion): void {
