...
@Component({
   selector: 'app-motivocalificacionconductor',
   templateUrl: './motivocalificacionconductor.component.html',
   styleUrls: ['./motivocalificacionconductor.component.scss']
})

export class MotivoCalificacionConductorComponent implements OnInit {

   busy: Promise<any>;
   entidades: MotivoCalificacionConductor[];
   entidadSeleccionada: MotivoCalificacionConductor;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: MotivoCalificacionConductorService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: MotivoCalificacionConductor): boolean {
      return true;
   }
   ...
   crearEntidad(): MotivoCalificacionConductor {
      const nuevoMotivoCalificacionConductor = new MotivoCalificacionConductor();
      nuevoMotivoCalificacionConductor.id = 0;
      return nuevoMotivoCalificacionConductor;
   }

   add(entidadNueva: MotivoCalificacionConductor): void {
   ...
   update(entidadParaActualizar: MotivoCalificacionConductor): void {
   ...
   delete(entidadParaBorrar: MotivoCalificacionConductor): void {
   ...
   refresh(): void {
      ...
      this.entidades = MotivoCalificacionConductor[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: MotivoCalificacionConductor): void {
