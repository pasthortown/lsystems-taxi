...
INSERT INTO `EstadoViaje` (`id`,`descripcion`) VALUES (2,'Finalizado');
INSERT INTO `EstadoViaje` (`id`,`descripcion`) VALUES (3,'Cancelado por Conductor');
INSERT INTO `EstadoViaje` (`id`,`descripcion`) VALUES (4,'Cancelado por Usuario');
